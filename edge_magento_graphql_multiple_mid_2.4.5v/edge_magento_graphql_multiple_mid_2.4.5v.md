...
```sh
    ...
    Once you have downloaded the extension files, unzip them and move them to the app/code
directory in your Magento installation. This is where all of your custom code and extensions
will be stored.
Note: Please create a code folder under <root>/app if it doesn’t already exist.
